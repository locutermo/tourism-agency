...
export default async function InternationalSection({ ...restProps }) {
    ...
    return <section id='international-destination' className="py-8 px-4 md:px-20 xl:px-[10%] flex z-10 flex-col w-full ">
        <h3 className="text-xl font-bold md:text-3xl text-center pt-14 text-[#4563ff] uppercase">Destinos internacionales</h3>
        <p className="text-center pb-14 py-4">Explora el mundo con nuestra agencia de viajes y descubre destinos extraordinarios</p>
