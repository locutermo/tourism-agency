...
export default async function HeaderMedia() {
    ...
    return <section className="w-full h-auto  self-center">
        <div className="relative w-full h-full">
            <div className="absolute z-20 w-full bg-black  h-full left-0 opacity-30"></div>
            ...
            <div className="absolute z-20 w-full h-full left-0">
                <div className="flex w-full md:w-2/3 lg:w-2/4 h-full px-8 md:px-20 lg:px-32 flex-col justify-center items-start ">
                    ...
                    <h1 className="text-white text-xs lg:text-base hidden md:block ">Descubre destinos internacionales (Mexico, Punta Cana, Brasil, Argentina, Colombia, Europa) y nacionales con Ruta Mundial. Paquetes turísticos personalizados con vuelos, alojamiento en hoteles de lujo, tours y seguros de viaje.</h1>
                    <p className="text-white text-xs lg:text-base hidden md:block font-bold">¡Reserva ahora y disfruta de la atención personalizada de nuestro equipo de expertos</p>
