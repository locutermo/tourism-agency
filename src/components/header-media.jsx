        ...
        <div className="relative w-full h-56 md:h-[450px] lg:min-h-screen">
            ...
            <div className="absolute z-40 w-full h-full left-0">
                <div className="flex w-full md:w-2/3 lg:w-2/4 h-full px-8 md:px-20 lg:px-32 flex-col justify-center items-start ">
                    ...
                    <h1 className="text-white font-extrabold  text-base mb-2 md:text-4xl lg:text-7xl">EXPERIENCIA</h1>
            ...
            <video autoPlay muted loop playsInline loading="eager" className="w-full">
